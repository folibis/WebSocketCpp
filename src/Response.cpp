...
Response::EncodingType Response::String2EncodingType(const std::string& str)
{
    ...
    {
        case _("gzip"):
            return Response::EncodingType::Gzip;
        case _("deflate"):
            return Response::EncodingType::Deflate;
        case _("chunked"):
            return Response::EncodingType::Chunked;
        case _("compress"):
            return Response::EncodingType::Compress;
        case _("br"):
            return Response::EncodingType::Brotli;
        default:
            break;
    }

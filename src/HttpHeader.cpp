...
HttpHeader::HeaderType HttpHeader::String2HeaderType(const std::string& str)
{
    ...
    {
        case _("Accept"):
            return HttpHeader::HeaderType::Accept;
        case _("Accept-Charset"):
            return HttpHeader::HeaderType::AcceptCharset;
        case _("Accept-Encoding"):
            return HttpHeader::HeaderType::AcceptEncoding;
        case _("Accept-Datetime"):
            return HttpHeader::HeaderType::AcceptDatetime;
        case _("Accept-Language"):
            return HttpHeader::HeaderType::AcceptLanguage;
        case _("Authorization"):
            return HttpHeader::HeaderType::Authorization;
        case _("Cache-Control"):
            return HttpHeader::HeaderType::CacheControl;
        case _("Connection"):
            return HttpHeader::HeaderType::Connection;
        case _("Content-Encoding"):
            return HttpHeader::HeaderType::ContentEncoding;
        case _("Content-Length"):
            return HttpHeader::HeaderType::ContentLength;
        case _("Content-MD5"):
            return HttpHeader::HeaderType::ContentMD5;
        case _("Content-Type"):
            return HttpHeader::HeaderType::ContentType;
        case _("Cookie"):
            return HttpHeader::HeaderType::Cookie;
        case _("Date"):
            return HttpHeader::HeaderType::Date;
        case _("Expect"):
            return HttpHeader::HeaderType::Expect;
        case _("Forwarded"):
            return HttpHeader::HeaderType::Forwarded;
        case _("From"):
            return HttpHeader::HeaderType::From;
        case _("HTTP2-Settings"):
            return HttpHeader::HeaderType::HTTP2Settings;
        case _("Host"):
            return HttpHeader::HeaderType::Host;
        case _("If-Match"):
            return HttpHeader::HeaderType::IfMatch;
        case _("If-Modified-Since"):
            return HttpHeader::HeaderType::IfModifiedSince;
        case _("If-None-Match"):
            return HttpHeader::HeaderType::IfNoneMatch;
        case _("If-Range"):
            return HttpHeader::HeaderType::IfRange;
        case _("If-Unmodified-Since"):
            return HttpHeader::HeaderType::IfUnmodifiedSince;
        case _("Max-Forwards"):
            return HttpHeader::HeaderType::MaxForwards;
        case _("Origin"):
            return HttpHeader::HeaderType::Origin;
        case _("Pragma"):
            return HttpHeader::HeaderType::Pragma;
        case _("Prefer"):
            return HttpHeader::HeaderType::Prefer;
        case _("Proxy-Authorization"):
            return HttpHeader::HeaderType::ProxyAuthorization;
        case _("Range"):
            return HttpHeader::HeaderType::Range;
        case _("Referer"):
            return HttpHeader::HeaderType::Referer;
        case _("TE"):
            return HttpHeader::HeaderType::TE;
        case _("Trailer"):
            return HttpHeader::HeaderType::Trailer;
        case _("TransferEncoding"):
            return HttpHeader::HeaderType::TransferEncoding;
        case _("User-Agent"):
            return HttpHeader::HeaderType::UserAgent;
        case _("Upgrade"):
            return HttpHeader::HeaderType::Upgrade;
        case _("Via"):
            return HttpHeader::HeaderType::Via;
        case _("Warning"):
            return HttpHeader::HeaderType::Warning;
...
std::string HttpHeader::HeaderType2String(HttpHeader::HeaderType headerType)
{
    switch (headerType)
    {
        case HttpHeader::HeaderType::Accept:
            return "Accept";
        case HttpHeader::HeaderType::AcceptCharset:
            return "Accept-Charset";
        case HttpHeader::HeaderType::AcceptEncoding:
            return "Accept-Encoding";
        case HttpHeader::HeaderType::AcceptDatetime:
            return "Accept-Datetime";
        case HttpHeader::HeaderType::AcceptLanguage:
            return "Accept-Language";
        case HttpHeader::HeaderType::Authorization:
            return "Authorization";
        case HttpHeader::HeaderType::CacheControl:
            return "Cache-Control";
        case HttpHeader::HeaderType::Connection:
            return "Connection";
        case HttpHeader::HeaderType::ContentEncoding:
            return "Content-Encoding";
        case HttpHeader::HeaderType::ContentLength:
            return "Content-Length";
        case HttpHeader::HeaderType::ContentMD5:
            return "Content-MD5";
        case HttpHeader::HeaderType::ContentType:
            return "Content-Type";
        case HttpHeader::HeaderType::Cookie:
            return "Cookie";
        case HttpHeader::HeaderType::Date:
            return "Date";
        case HttpHeader::HeaderType::Expect:
            return "Expect";
        case HttpHeader::HeaderType::Forwarded:
            return "Forwarded";
        case HttpHeader::HeaderType::From:
            return "From";
        case HttpHeader::HeaderType::HTTP2Settings:
            return "HTTP2-Settings";
        case HttpHeader::HeaderType::Host:
            return "Host";
        case HttpHeader::HeaderType::IfMatch:
            return "If-Match";
        case HttpHeader::HeaderType::IfModifiedSince:
            return "If-Modified-Since";
        case HttpHeader::HeaderType::IfNoneMatch:
            return "If-None-Match";
        case HttpHeader::HeaderType::IfRange:
            return "If-Range";
        case HttpHeader::HeaderType::IfUnmodifiedSince:
            return "If-Unmodified-Since";
        case HttpHeader::HeaderType::MaxForwards:
            return "Max-Forwards";
        case HttpHeader::HeaderType::Origin:
            return "Origin";
        case HttpHeader::HeaderType::Pragma:
            return "Pragma";
        case HttpHeader::HeaderType::Prefer:
            return "Prefer";
        case HttpHeader::HeaderType::ProxyAuthorization:
            return "Proxy-Authorization";
        case HttpHeader::HeaderType::Range:
            return "Range";
        case HttpHeader::HeaderType::Referer:
            return "Referer";
        case HttpHeader::HeaderType::TE:
            return "TE";
        case HttpHeader::HeaderType::Trailer:
            return "Trailer";
        case HttpHeader::HeaderType::TransferEncoding:
            return "Transfer-Encoding";
        case HttpHeader::HeaderType::UserAgent:
            return "User-Agent";
        case HttpHeader::HeaderType::Upgrade:
            return "Upgrade";
        case HttpHeader::HeaderType::Via:
            return "Via";
        case HttpHeader::HeaderType::Warning:
            return "Warning";
